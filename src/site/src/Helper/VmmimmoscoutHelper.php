...
//
    ...
    class VmmimmoscoutHelper extends ContentHelper
    {
         ...
         */
        public static function realestatesAPIHelper($isSingle, $start, $total)
        {
            ...
            if(!$isSingle)
            {
                $params['pagesize'] = $realestatePageSize;
                $params['pagenumber'] =  ($start / $realestatePageSize) + 1;
            }
