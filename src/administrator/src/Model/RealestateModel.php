...
/**
 * Item Model for a Realestate.
 *
 * @since  1.0.0
 */
class RealestateModel extends AdminModel
{
	 ...
	 * @since    1.0.0
	 */
	public $typeAlias = 'com_vmmimmoscout.realestate';

	/**
	 * @var    string  The prefix to use with controller messages.
	 * @since  1.0.0
	 */
	protected $text_prefix = 'COM_VMMIMMOSCOUT';
	...
	public function getForm($data = [], $loadData = true)
	{
		// Get the form.
        $form = $this->loadForm(
            'com_vmmimmoscout.' . $this->formName,
            $this->formName,
            array(
                'control' => 'jform',
                'load_data' => $loadData
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_vmmimmoscout.edit.realestate.data', array());

		if (empty($data))
		{
			$data = $this->getItem();
		}
		$this->preprocessData($this->typeAlias, $data, 'realestate');
